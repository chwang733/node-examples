...
var pb_helloworld_pb = require('../pb/helloworld_pb.js');

function serialize_helloworld_HelloReply(arg) {
  if (!(arg instanceof pb_helloworld_pb.HelloReply)) {
...
function deserialize_helloworld_HelloReply(buffer_arg) {
  return pb_helloworld_pb.HelloReply.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_helloworld_HelloRequest(arg) {
  if (!(arg instanceof pb_helloworld_pb.HelloRequest)) {
...
function deserialize_helloworld_HelloRequest(buffer_arg) {
  return pb_helloworld_pb.HelloRequest.deserializeBinary(new Uint8Array(buffer_arg));
}
...
var GreeterService = exports.GreeterService = {
  ...
  sayHello: {
    ...
    requestType: pb_helloworld_pb.HelloRequest,
    responseType: pb_helloworld_pb.HelloReply,
